 ...
 *
 * ## Why the row cannot key off speech
 *
 ...
 * HERE. That fact is this module. It is what turns the launcher pills into the
 * single `start` pill that offers `pavilio-session-start` instead — the step
 * that actually follows a launch.
 *
 ...
 * whose agent had just been launched, and the launcher pills would come back in
 * place of the start pill.
 *
